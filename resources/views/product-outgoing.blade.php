            ...
            <div class="row box">
                @forelse($sales as $s)
                    ...
                    <div class = "col-lg-12 text-right mt-3">
                        <button type="button" class="btn btn-get-started" data-id = "{{$s->id}}" data-toggle = "modal" data-target = '#modal-confirm-{{$s->id}}'><strong>Show Detail</strong></button>
                    </div>
                                ...
                                <div class="modal-footer">
                                    <div class = "row">
                                        <div class = "col text-center">
                                            <button type = "button" class = "btn-get-started btn-confirm" data-id = {{$s->id}}>Confirm</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
